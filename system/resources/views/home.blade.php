                        ...
                        <div class=" col-lg-3 ftco-animate ">
                          <div class="">
                            ...
                            <div class="card text py-4 pb-4 px-4 text-center">
                              ...
                              <p class="buttons ml-2"><a href="test-ajax" class="btn btn-dark"><i class="fa fa-shooping-cart"></i>Add to Card</a></p>
                              <!-- <a href="{{url('card')}}" class="btn btn-dark" data-target="#dtracker" data-toggle="modal" >add to card</a> -->
